...
export default function TermsAndConditions() {  
  return (  
    <>  
      <Navbar />  
      <div className="container mx-auto px-4 py-8 md:py-12 bg-gray-100 min-h-screen mt-40 rounded-md mb-8 md:mt-28">  
        <h1 className="text-4xl font-bold mb-8 text-center text-gray-800">Terms and Conditions of Use</h1>  
        <p className="text-gray-600 mb-12 text-center">Updated: January 2025</p>  
        <section className="space-y-8">  
          ...
          <div>  
            <h3 className="text-2xl font-semibold mb-2 text-gray-800">Services Provided</h3>  
            <p className="text-gray-700 mb-4">  
          ...
          <div>  
            <h3 className="text-2xl font-semibold mb-2 text-gray-800">Acceptance of Terms</h3>  
            <p className="text-gray-700 mb-4">  
          ...
          <div>  
            <h3 className="text-2xl font-semibold mb-2 text-gray-800">Use of the Website</h3>  
            <p className="text-gray-700 mb-4">  
          ...
          <div>  
            <h3 className="text-2xl font-semibold mb-2 text-gray-800">Consultancy Services</h3>  
            <p className="text-gray-700 mb-4">  
          ...
          <div>  
            <h3 className="text-2xl font-semibold mb-2 text-gray-800">User Account & Responsibilities</h3>  
            <p className="text-gray-700 mb-4">  
          ...
          <div>  
            <h3 className="text-2xl font-semibold mb-2 text-gray-800">Payments and Fees</h3>  
            <p className="text-gray-700 mb-4">  
          ...
          <div>  
            <h3 className="text-2xl font-semibold mb-2 text-gray-800">Intellectual Property</h3>  
            <p className="text-gray-700 mb-4">  
          ...
          <div>  
            <h3 className="text-2xl font-semibold mb-2 text-gray-800">Disclaimer of Warranties</h3>  
            <p className="text-gray-700 mb-4">  
          ...
          <div>  
            <h3 className="text-2xl font-semibold mb-2 text-gray-800">Limitation of Liability</h3>  
            <p className="text-gray-700 mb-4">  
          ...
          <div>  
            <h3 className="text-2xl font-semibold mb-2 text-gray-800">Indemnification</h3>  
            <p className="text-gray-700 mb-4">  
          ...
          <div>  
            <h3 className="text-2xl font-semibold mb-2 text-gray-800">Privacy Policy</h3>  
            <p className="text-gray-700 mb-4">  
          ...
          <div>  
            <h3 className="text-2xl font-semibold mb-2 text-gray-800">Changes to Terms</h3>  
            <p className="text-gray-700 mb-4">  
          ...
          <div>  
            <h3 className="text-2xl font-semibold mb-2 text-gray-800">Termination</h3>  
            <p className="text-gray-700 mb-4">  
          ...
          <div>  
            <h3 className="text-2xl font-semibold mb-2 text-gray-800">Force Majeure</h3>  
            <p className="text-gray-700 mb-4">  
          ...
          <div>  
            <h3 className="text-2xl font-semibold mb-2 text-gray-800">Severability</h3>  
            <p className="text-gray-700 mb-4">  
          ...
          <div>  
            <h3 className="text-2xl font-semibold mb-2 text-gray-800">Entire Agreement</h3>  
            <p className="text-gray-700 mb-4">  
          ...
          <div>  
            <h3 className="text-2xl font-semibold mb-2 text-gray-800">Contact Information</h3>  
            <p className="text-gray-700 mb-4">  
