  ...
  return (
    <div className="relative isolate bg-white" id={'contact'}>
      <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
        ...
        <form action="#" method="POST" className="px-6 pb-12 pt-4 sm:pb-16 lg:px-8 lg:py-16">
              ...
              <div className="sm:col-span-2">
                ...
                <div className="mt-2.5">
                  ...
                  <span className='text-gray-400 font-normal font-["arial"] text-xs'>
                    By entering your number you agree to receive text messages from AAHM. Reply STOP to unsubscribe. Message & data rates may apply.
                  </span>
                </div>
              </div>
              <div className="sm:col-span-2">
